...
fn test_bip38_decryption_compressed() {
    let encrypted_key = "6PYMgbeR64ypE4g8ZQhGo7ScudV5BLz1vMFUCs49AWpW3jVNWfH6cAdTi2";
    let password = "strong_pass";
    
    let result = encrypted_key.decrypt(password);
...
fn test_bip38_decryption_with_generated_example() {
    ...
    let public_key = "1KynBkuVVJSdVkpFq7pvKCwXTKriK6CDPE";
